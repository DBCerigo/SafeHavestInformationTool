...
filtered_data.to_csv(f'data/computed/Shellfish_classification_England_and_Wales_08032023_Classification_list_2022-2023_pacific_oysters.csv', index=False)
